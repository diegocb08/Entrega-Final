...
function filtrarNombre() {
  ...
  const productosFiltrados = productos.filter((producto) =>
    producto.nombre.toLowerCase().includes(filtroUsuario)
  );

  // Actualizar el DOM con los productos filtrados
  const productosGrid = document.getElementById("productos-grid");
  productosGrid.innerHTML = ""; // Limpiar el grid
...
// Filtramos cada vez que se escribe algo en el input en tiempo real
document
  .getElementById("filtro-texto")
  .addEventListener("input", filtrarNombre);
